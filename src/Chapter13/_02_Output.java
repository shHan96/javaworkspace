...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%06d%n",1234); // 001234 (6자리의 공간 확보 후 1234 출력하는데 빈공간은 0 으로 출력)
        ...
        System.out.printf("%6.2f%n",Math.PI);//__3.14 (6자리 공간 확보하고 소수점 둘재자리)
        ...
        System.out.printf("%-6.2s%n","Java"); // Ja____ (6자리 공간 확보하고 좌측으로 정렬해서 2글자 출력)
        ...
        System.out.printf("%-6s %4d %4d %6.1f%n","강백호", 100, 100, 100.0);
